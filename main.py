...
# https://stackoverflow.com/questions/51551081/how-to-find-usb-devices-and-communicate-with-them-using-pyserial-in-android
# https://groups.google.com/g/kivy-users/c/GcN15VS3NA0
# https://github.com/jacklinquan/usbserial4a
# https://github.com/markqvist/Sideband/blob/main/sbapp/Makefile
...
class HW:
    ...
    def send_data(self, data, timeout):
        if self.device:
            if platform == "android":
                # self.device.write(data, timeout)
